...
for (let i = 1; i <= 5; i++) {
  ...
  do {
    sexo = prompt(`Digite o sexo da pessoa ${i} (Masculino ou Feminino):`).toLowerCase();
...
document.write(`Quantidade de pessoas do sexo masculino: ${masculino} <br>`);
document.write(`Quantidade de pessoas do sexo feminino: ${feminino} <br>`);
document.write(`Porcentagem de destros: ${porcentagemDestro.toFixed(2)}% <br>`);
document.write(`Porcentagem de canhotos: ${porcentagemCanhoto.toFixed(2)}%`);